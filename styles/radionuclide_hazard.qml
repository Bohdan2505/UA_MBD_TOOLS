...
<qgis styleCategories="Symbology|Labeling|Fields" labelsEnabled="0" version="3.40.0-Bratislava">
  <renderer-v2 type="RuleRenderer" symbollevels="0" referencescale="-1" enableorderby="0" forceraster="0">
    <rules key="{bed1b8e4-3a42-4b20-8db8-dac2a2560e0a}">
      <rule symbol="0" key="{bc0b64b6-26c1-4203-a20b-774be4ec4670}"/>
    </rules>
    <symbols>
      <symbol type="fill" frame_rate="10" clip_to_extent="1" alpha="1" is_animated="0" name="0" force_rhr="0">
        ...
        <layer id="{5ffbdf99-a93d-4f71-9f75-e8a1b5834074}" locked="0" enabled="1" class="SimpleLine" pass="0">
          <Option type="Map">
            ...
            <Option type="QString" name="line_color" value="134,255,0,255,rgb:0.52549019607843139,1,0,1"/>
        ...
        <layer id="{b2631862-3b02-400b-bc20-b40dcf73a9c9}" locked="0" enabled="1" class="MarkerLine" pass="0">
          <Option type="Map">
          ...
          <symbol type="marker" frame_rate="10" clip_to_extent="1" alpha="1" is_animated="0" name="@0@1" force_rhr="0">
            ...
            <layer id="{e7da4f7e-378c-4449-b837-473060eef046}" locked="0" enabled="1" class="SimpleMarker" pass="0">
              <Option type="Map">
                ...
                <Option type="QString" name="offset_map_unit_scale" value="3x:0,0,0,0,0,0"/>
                <Option type="QString" name="offset_unit" value="MM"/>
                <Option type="QString" name="outline_color" value="134,255,0,255,rgb:0.52549019607843139,1,0,1"/>
        ...
        <layer id="{f5f29c4c-3509-4946-a3ce-838a18612691}" locked="0" enabled="1" class="MarkerLine" pass="0">
          <Option type="Map">
            <Option type="QString" name="average_angle_length" value="4"/>
            <Option type="QString" name="average_angle_map_unit_scale" value="3x:0,0,0,0,0,0"/>
            <Option type="QString" name="average_angle_unit" value="MM"/>
          ...
          <symbol type="marker" frame_rate="10" clip_to_extent="1" alpha="1" is_animated="0" name="@0@2" force_rhr="0">
            ...
            <layer id="{2cd202fe-c682-45d1-939f-e7368b12279f}" locked="0" enabled="1" class="SimpleMarker" pass="0">
              <Option type="Map">
  ...
  <fieldConfiguration>
    ...
    <field name="dose" configurationFlags="NoFlag"/>
  ...
  <aliases>
    ...
    <alias field="dose" index="11" name="експозиційна доза, рентген&#xa;"/>
    <alias field="hazard" index="12" name="якісна оцінка небезпеки&#xa;"/>
  </aliases>
  <splitPolicies>
    ...
    <policy policy="Duplicate" field="dose"/>
  ...
  <defaults>
    ...
    <default field="dose" expression="" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint field="dose" unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0"/>
    <constraint field="hazard" unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint field="dose" exp="" desc=""/>
    <constraint field="hazard" exp="" desc=""/>
  </constraintExpressions>
  <expressionfields/>
