...
<qgis styleCategories="Symbology|Labeling|Fields" labelsEnabled="0" version="3.40.0-Bratislava">
  <renderer-v2 type="RuleRenderer" symbollevels="0" referencescale="-1" enableorderby="0" forceraster="0">
    <rules key="{ee367d8e-6990-4f3a-9543-b556412bc6b3}">
      <rule symbol="0" filter="res_code='06.01.1'" label="території в червоних лініях" key="{df25bb9b-44ae-4ba4-a01e-171c8819cfb2}"/>
    </rules>
    <symbols>
      <symbol type="fill" frame_rate="10" clip_to_extent="1" alpha="1" is_animated="0" name="0" force_rhr="0">
        ...
        <layer id="{cebe3186-aaca-4eea-b485-a86736ea8ba4}" locked="0" enabled="1" class="SimpleLine" pass="0">
          <Option type="Map">
            ...
            <Option type="QString" name="line_color" value="128,0,0,255,rgb:0.50196078431372548,0,0,1"/>
