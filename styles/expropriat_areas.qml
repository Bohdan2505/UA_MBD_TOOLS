...
<qgis styleCategories="Symbology|Labeling|Fields" labelsEnabled="0" version="3.40.0-Bratislava">
  <renderer-v2 type="RuleRenderer" symbollevels="0" referencescale="-1" enableorderby="0" forceraster="0">
    <rules key="{bcb3fdc7-4de5-4794-9164-8eb38dceb7e5}">
      <rule symbol="0" filter="ELSE" label="території, до складу яких входять земельні ділянки, необхідні для розміщення об'єктів, щодо яких відповідно до закону може здійснюватися примусове відчуження земельних ділянок з мотивів суспільної необхідності" key="{5f0903f3-fb3c-4fdc-8807-5c3170fcf164}"/>
    </rules>
    <symbols>
      <symbol type="fill" frame_rate="10" clip_to_extent="1" alpha="1" is_animated="0" name="0" force_rhr="0">
        ...
        <layer id="{eb040c3a-5836-4eba-ac94-8a9db2938506}" locked="0" enabled="1" class="LinePatternFill" pass="0">
          <Option type="Map">
            <Option type="QString" name="angle" value="45"/>
            <Option type="QString" name="clip_mode" value="during_render"/>
            <Option type="QString" name="color" value="90,0,255,255,rgb:0.35294117647058826,0,1,1"/>
          ...
          <symbol type="line" frame_rate="10" clip_to_extent="1" alpha="1" is_animated="0" name="@0@0" force_rhr="0">
            ...
            <layer id="{531419d6-eabc-42a6-896e-8b29c89ab00e}" locked="0" enabled="1" class="SimpleLine" pass="0">
              <Option type="Map">
                ...
                <Option type="QString" name="line_color" value="90,0,255,255,rgb:0.35294117647058826,0,1,1"/>
        ...
        <layer id="{78c16432-2b34-4117-ac0c-2152adb64704}" locked="0" enabled="1" class="SimpleLine" pass="0">
          <Option type="Map">
            <Option type="QString" name="align_dash_pattern" value="0"/>
            <Option type="QString" name="capstyle" value="square"/>
            <Option type="QString" name="customdash" value="5;2"/>
  ...
  <aliases>
    ...
    <alias field="purpose" index="13" name="призначення"/>
  </aliases>
  <splitPolicies>
  ...
  <defaults>
    ...
    <default field="katotth" expression="&#xa;@katotth" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint field="purpose" unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0"/>
  </constraints>
