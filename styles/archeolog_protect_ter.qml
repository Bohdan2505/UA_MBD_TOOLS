...
<qgis styleCategories="Symbology|Labeling|Fields" labelsEnabled="0" version="3.40.0-Bratislava">
  <renderer-v2 type="RuleRenderer" symbollevels="0" referencescale="-1" enableorderby="0" forceraster="0">
    <rules key="{fb98b9a5-4bb7-4595-898c-e7c289004ec3}">
      <rule symbol="0" filter="ELSE" label="охоронювана археологічна територія" key="{611939d3-13fb-4393-ae6d-e62539efc636}"/>
    </rules>
    <symbols>
      <symbol type="fill" frame_rate="10" clip_to_extent="1" alpha="1" is_animated="0" name="0" force_rhr="0">
        ...
        <layer id="{5b1b2fe5-4dce-4f75-aa75-65e13830a724}" locked="0" enabled="1" class="SimpleLine" pass="0">
          <Option type="Map">
        ...
        <layer id="{64b450fd-6bba-404d-804b-a72b58dd00b8}" locked="0" enabled="1" class="MarkerLine" pass="0">
          <Option type="Map">
          ...
          <symbol type="marker" frame_rate="10" clip_to_extent="1" alpha="1" is_animated="0" name="@0@1" force_rhr="0">
            ...
            <layer id="{ee4f6b0a-08c9-4531-90b9-6982cece2261}" locked="0" enabled="1" class="FontMarker" pass="0">
              <Option type="Map">
                <Option type="QString" name="angle" value="0"/>
                <Option type="QString" name="chr" value="KС"/>
        ...
        <layer id="{669eac48-d37a-4f2b-93c3-ec0abb98c97d}" locked="0" enabled="1" class="MarkerLine" pass="0">
          <Option type="Map">
            <Option type="QString" name="average_angle_length" value="4"/>
            <Option type="QString" name="average_angle_map_unit_scale" value="3x:0,0,0,0,0,0"/>
            <Option type="QString" name="average_angle_unit" value="MM"/>
          ...
          <symbol type="marker" frame_rate="10" clip_to_extent="1" alpha="1" is_animated="0" name="@0@2" force_rhr="0">
            ...
            <layer id="{984195b6-9215-438d-bbfb-b72ca8e8fd67}" locked="0" enabled="1" class="SimpleMarker" pass="0">
              <Option type="Map">
                <Option type="QString" name="angle" value="0"/>
