...
<qgis styleCategories="Symbology|Labeling|Fields" labelsEnabled="0" version="3.40.0-Bratislava">
  <renderer-v2 type="RuleRenderer" symbollevels="0" referencescale="-1" enableorderby="0" forceraster="0">
    <rules key="{3e1e9f3d-9843-4dff-ae96-a3e22f0b9f15}">
      <rule symbol="0" key="{b300d8f5-a5f1-4246-a5fd-a67b95190b95}"/>
    </rules>
    <symbols>
      <symbol type="fill" frame_rate="10" clip_to_extent="1" alpha="1" is_animated="0" name="0" force_rhr="0">
        ...
        <layer id="{a9744a83-5f02-43fe-b0f7-b959171c4f65}" locked="0" enabled="1" class="SimpleLine" pass="0">
          <Option type="Map">
            <Option type="QString" name="align_dash_pattern" value="0"/>
            <Option type="QString" name="capstyle" value="square"/>
            <Option type="QString" name="customdash" value="13;17"/>
            ...
            <Option type="QString" name="line_color" value="0,0,132,255,rgb:0,0,0.51764705882352946,1"/>
        ...
        <layer id="{6030232e-091c-49b6-a6d3-ddaf7b77edf6}" locked="0" enabled="1" class="MarkerLine" pass="0">
          <Option type="Map">
          ...
          <symbol type="marker" frame_rate="10" clip_to_extent="1" alpha="1" is_animated="0" name="@0@1" force_rhr="0">
            ...
            <layer id="{2b767718-74ec-41f6-932f-02e6502b3557}" locked="0" enabled="1" class="FontMarker" pass="0">
              <Option type="Map">
                <Option type="QString" name="angle" value="0"/>
                <Option type="QString" name="chr" value="ГВ"/>
                <Option type="QString" name="color" value="0,0,132,255,rgb:0,0,0.51764705882352946,1"/>
  ...
  <fieldConfiguration>
    ...
    <field name="term" configurationFlags="NoFlag"/>
  ...
  <aliases>
    ...
    <alias field="number" index="11" name="номер акту"/>
    <alias field="date" index="12" name="дата видачі спецдозволу"/>
    <alias field="term" index="13" name="кінець дії спецдозволу"/>
    <alias field="user" index="14" name="надрокористувач"/>
  </aliases>
  <splitPolicies>
    ...
    <policy policy="Duplicate" field="term"/>
  ...
  <defaults>
    ...
    <default field="term" expression="" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint field="number" unique_strength="0" notnull_strength="1" exp_strength="0" constraints="1"/>
    <constraint field="date" unique_strength="0" notnull_strength="1" exp_strength="0" constraints="1"/>
    <constraint field="term" unique_strength="0" notnull_strength="1" exp_strength="0" constraints="1"/>
    <constraint field="user" unique_strength="0" notnull_strength="1" exp_strength="0" constraints="1"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint field="term" exp="" desc=""/>
