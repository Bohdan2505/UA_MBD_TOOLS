...
<qgis styleCategories="Symbology|Labeling|Fields" labelsEnabled="0" version="3.40.0-Bratislava">
  <renderer-v2 type="RuleRenderer" symbollevels="0" referencescale="-1" enableorderby="0" forceraster="0">
    <rules key="{d0fb0951-dd43-442e-902e-0bcc29e91ca2}">
      <rule symbol="0" key="{3f0ece89-23c7-404f-ad74-805414d03f85}"/>
    </rules>
    <symbols>
      <symbol type="line" frame_rate="10" clip_to_extent="1" alpha="1" is_animated="0" name="0" force_rhr="0">
        ...
        <layer id="{f0d07a0b-be9d-4462-8d01-0086dcabc946}" locked="0" enabled="1" class="SimpleLine" pass="0">
          <Option type="Map">
            ...
            <Option type="QString" name="line_color" value="32,191,39,255,rgb:0.12549019607843137,0.74901960784313726,0.15294117647058825,1"/>
        ...
        <layer id="{814c71be-253c-487f-8de3-456831c0b4a0}" locked="0" enabled="1" class="SimpleLine" pass="0">
          <Option type="Map">
            <Option type="QString" name="align_dash_pattern" value="0"/>
            <Option type="QString" name="capstyle" value="square"/>
            <Option type="QString" name="customdash" value="5;2"/>
        ...
        <layer id="{ab9e9d51-9318-4d2c-bc9d-49da904cd81b}" locked="0" enabled="1" class="MarkerLine" pass="0">
          <Option type="Map">
          ...
          <symbol type="marker" frame_rate="10" clip_to_extent="1" alpha="1" is_animated="0" name="@0@2" force_rhr="0">
            ...
            <layer id="{417af3f8-a646-451a-9af6-89a2b5d55858}" locked="0" enabled="1" class="SimpleMarker" pass="0">
              <Option type="Map">
  ...
  <constraints>
    ...
    <constraint field="source" unique_strength="2" notnull_strength="1" exp_strength="0" constraints="3"/>
