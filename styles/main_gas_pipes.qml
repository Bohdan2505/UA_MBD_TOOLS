...
<qgis styleCategories="Symbology|Labeling|Fields" labelsEnabled="0" version="3.40.0-Bratislava">
  <renderer-v2 type="RuleRenderer" symbollevels="0" referencescale="-1" enableorderby="0" forceraster="0">
    <rules key="{b8caa457-2e4a-49e1-9d68-4a7171c976d7}">
      <rule symbol="0" filter="&quot;state&quot; in (1,2,3,4,5,6,7,13)" label="існуючі" key="{a9bfe483-48f9-4406-b379-b1a261d3da35}"/>
      <rule symbol="1" filter="&quot;state&quot; in (8,9,10,11,12)" label="проектні" key="{37a1d117-c8fb-48cc-adfa-817d7183bc5a}"/>
      <rule symbol="2" filter="ELSE" label="інші" key="{75d4d230-8c6f-4456-a7c7-6675a148f33a}"/>
    </rules>
    <symbols>
      <symbol type="line" frame_rate="10" clip_to_extent="1" alpha="1" is_animated="0" name="0" force_rhr="0">
        ...
        <layer id="{555011e5-42ca-4751-82a5-c3746b6052ef}" locked="0" enabled="1" class="SimpleLine" pass="0">
          <Option type="Map">
        ...
        <layer id="{cf8f42ad-04a1-4c00-9d31-16985f0269e9}" locked="0" enabled="1" class="MarkerLine" pass="0">
          <Option type="Map">
          ...
          <symbol type="marker" frame_rate="10" clip_to_extent="1" alpha="1" is_animated="0" name="@0@1" force_rhr="0">
            ...
            <layer id="{5669eedf-6b88-4184-9cf6-f8ce787b7cb1}" locked="0" enabled="1" class="SimpleMarker" pass="0">
              <Option type="Map">
            ...
            <layer id="{5c7e63e0-f7cf-43b4-9838-dbc092f4951d}" locked="0" enabled="1" class="FontMarker" pass="0">
              <Option type="Map">
                <Option type="QString" name="angle" value="0"/>
                <Option type="QString" name="chr" value="ГМ"/>
                ...
                <Option type="Map">
                  ...
                  <Option type="Map" name="properties">
                    <Option type="Map" name="char">
                      ...
                      <Option type="QString" name="expression" value="'ГМ'"/>
      ...
      <symbol type="line" frame_rate="10" clip_to_extent="1" alpha="1" is_animated="0" name="1" force_rhr="0">
        ...
        <layer id="{1fa689d4-42b3-40d9-b92c-6d6d3d5f88e2}" locked="0" enabled="1" class="SimpleLine" pass="0">
          <Option type="Map">
            <Option type="QString" name="align_dash_pattern" value="0"/>
            <Option type="QString" name="capstyle" value="square"/>
        ...
        <layer id="{7a590656-3e3d-49bf-97c7-19503ed3850c}" locked="0" enabled="1" class="MarkerLine" pass="0">
          <Option type="Map">
            <Option type="QString" name="average_angle_length" value="0"/>
            <Option type="QString" name="average_angle_map_unit_scale" value="3x:0,0,0,0,0,0"/>
            <Option type="QString" name="average_angle_unit" value="MM"/>
          ...
          <symbol type="marker" frame_rate="10" clip_to_extent="1" alpha="1" is_animated="0" name="@1@1" force_rhr="0">
            ...
            <layer id="{d8ab23c5-60df-46fe-89a1-38f3a6a36435}" locked="0" enabled="1" class="SimpleMarker" pass="0">
              <Option type="Map">
            ...
            <layer id="{35619536-ed9d-40ba-be59-1bbd09cfe1c5}" locked="0" enabled="1" class="FontMarker" pass="0">
              <Option type="Map">
                <Option type="QString" name="angle" value="0"/>
                <Option type="QString" name="chr" value="Гм"/>
                <Option type="QString" name="color" value="49,133,155,255,rgb:0.19215686274509805,0.52156862745098043,0.60784313725490191,1"/>
      ...
      <symbol type="line" frame_rate="10" clip_to_extent="1" alpha="1" is_animated="0" name="2" force_rhr="0">
        ...
        <layer id="{8c167064-d6a2-45ec-b275-432e521de09a}" locked="0" enabled="1" class="SimpleLine" pass="0">
          <Option type="Map">
            <Option type="QString" name="align_dash_pattern" value="0"/>
            <Option type="QString" name="capstyle" value="square"/>
            <Option type="QString" name="customdash" value="3;2;3;2;3;2;3;8.0001"/>
            ...
            <Option type="QString" name="draw_inside_polygon" value="0"/>
            <Option type="QString" name="joinstyle" value="miter"/>
            <Option type="QString" name="line_color" value="155,155,155,255,rgb:0.60784313725490191,0.60784313725490191,0.60784313725490191,1"/>
            <Option type="QString" name="line_style" value="solid"/>
            <Option type="QString" name="line_width" value="0.5"/>
            <Option type="QString" name="line_width_unit" value="MM"/>
            <Option type="QString" name="offset" value="0"/>
        ...
        <layer id="{fc417c4c-4870-4954-b448-524ad7aafd05}" locked="0" enabled="1" class="MarkerLine" pass="0">
          <Option type="Map">
            <Option type="QString" name="average_angle_length" value="0"/>
            <Option type="QString" name="average_angle_map_unit_scale" value="3x:0,0,0,0,0,0"/>
            <Option type="QString" name="average_angle_unit" value="MM"/>
          ...
          <symbol type="marker" frame_rate="10" clip_to_extent="1" alpha="1" is_animated="0" name="@2@1" force_rhr="0">
            ...
            <layer id="{97bb945c-4029-42e7-a1a8-d437f7f946ba}" locked="0" enabled="1" class="SimpleMarker" pass="0">
              <Option type="Map">
                <Option type="QString" name="angle" value="90"/>
                <Option type="QString" name="cap_style" value="square"/>
            ...
            <layer id="{a78f355b-0fdf-4d60-ab3e-ad36df50aa66}" locked="0" enabled="1" class="FontMarker" pass="0">
              <Option type="Map">
                <Option type="QString" name="angle" value="0"/>
                <Option type="QString" name="chr" value="ГМ"/>
                <Option type="QString" name="color" value="155,155,155,255,rgb:0.60784313725490191,0.60784313725490191,0.60784313725490191,1"/>
  ...
  <fieldConfiguration>
    ...
    <field name="_class" configurationFlags="NoFlag"/>
    ...
    <field name="pres_in" configurationFlags="NoFlag"/>
    <field name="pres_pr" configurationFlags="NoFlag"/>
    <field name="pres_pro" configurationFlags="NoFlag"/>
    <field name="pres_ext" configurationFlags="NoFlag"/>
  ...
  <aliases>
    ...
    <alias field="diameter" index="17" name="переважний діаметр, мм"/>
    <alias field="pres_in" index="18" name="тиск існуючий, МПа"/>
    <alias field="pres_pr" index="19" name="тиск на короткостроковий період, МПа"/>
    <alias field="pres_pro" index="20" name="тиск на середньостроковий період, МПа"/>
    <alias field="pres_ext" index="21" name="тиск на довгостроковий період, МПа"/>
    <alias field="z_kind" index="22" name="характер встановлення зони"/>
    <alias field="pr_zone" index="23" name="розмір охоронної зони, м"/>
  ...
  <splitPolicies>
    ...
    <policy policy="Duplicate" field="_class"/>
    <policy policy="Duplicate" field="category"/>
    <policy policy="Duplicate" field="name"/>
    <policy policy="Duplicate" field="diameter"/>
    <policy policy="Duplicate" field="pres_in"/>
    <policy policy="Duplicate" field="pres_pr"/>
    <policy policy="Duplicate" field="pres_pro"/>
    <policy policy="Duplicate" field="pres_ext"/>
  ...
  <defaults>
    ...
    <default field="_class" expression="0" applyOnUpdate="0"/>
    <default field="category" expression="0" applyOnUpdate="0"/>
    <default field="name" expression="" applyOnUpdate="0"/>
    <default field="diameter" expression="" applyOnUpdate="0"/>
    <default field="pres_in" expression="" applyOnUpdate="0"/>
    <default field="pres_pr" expression="" applyOnUpdate="0"/>
    <default field="pres_pro" expression="" applyOnUpdate="0"/>
    <default field="pres_ext" expression="" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint field="_class" unique_strength="0" notnull_strength="1" exp_strength="0" constraints="1"/>
    ...
    <constraint field="pres_in" unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0"/>
    <constraint field="pres_pr" unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0"/>
    <constraint field="pres_pro" unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0"/>
    <constraint field="pres_ext" unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0"/>
    <constraint field="z_kind" unique_strength="0" notnull_strength="1" exp_strength="0" constraints="1"/>
    <constraint field="pr_zone" unique_strength="0" notnull_strength="1" exp_strength="0" constraints="1"/>
  ...
  <constraintExpressions>
    ...
    <constraint field="_class" exp="" desc=""/>
    <constraint field="category" exp="" desc=""/>
    <constraint field="name" exp="" desc=""/>
    <constraint field="diameter" exp="" desc=""/>
    <constraint field="pres_in" exp="" desc=""/>
    <constraint field="pres_pr" exp="" desc=""/>
    <constraint field="pres_pro" exp="" desc=""/>
    <constraint field="pres_ext" exp="" desc=""/>
