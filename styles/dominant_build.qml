...
<qgis styleCategories="Symbology|Labeling|Fields" labelsEnabled="0" version="3.40.0-Bratislava">
  <renderer-v2 type="RuleRenderer" symbollevels="0" referencescale="-1" enableorderby="0" forceraster="0">
    <rules key="{9b7c0cfd-4cb2-4e12-ad5e-9c4954e80366}">
      <rule symbol="0" key="{3bc8560d-1e71-4f67-9b4e-bdc1db055400}"/>
    </rules>
    <symbols>
      <symbol type="marker" frame_rate="10" clip_to_extent="1" alpha="0.835" is_animated="0" name="0" force_rhr="0">
        ...
        <layer id="{1bca7ff9-fffd-4be3-959c-659e721e7332}" locked="0" enabled="1" class="SimpleMarker" pass="0">
          <Option type="Map">
        ...
        <layer id="{b9973c54-2b80-4ef5-9011-e7368c2ef733}" locked="0" enabled="1" class="SvgMarker" pass="0">
          <Option type="Map">
            <Option type="QString" name="angle" value="0"/>
  ...
  <aliases>
    ...
    <alias field="str_guid" index="11" name=""/>
