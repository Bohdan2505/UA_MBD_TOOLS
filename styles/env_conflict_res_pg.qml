...
<qgis styleCategories="Symbology|Labeling|Fields" labelsEnabled="0" version="3.40.0-Bratislava">
  <renderer-v2 type="RuleRenderer" symbollevels="0" referencescale="-1" enableorderby="0" forceraster="0">
    <rules key="{93166481-3161-4317-8140-75956d83c0a7}">
      <rule symbol="0" key="{6d73f206-8b81-41c0-9b7b-11eaf8b14b76}"/>
    </rules>
    <symbols>
      <symbol type="fill" frame_rate="10" clip_to_extent="1" alpha="1" is_animated="0" name="0" force_rhr="0">
        ...
        <layer id="{5a2e1f28-3de5-44b5-ae5a-08a93f9b7f12}" locked="0" enabled="1" class="SimpleFill" pass="0">
          <Option type="Map">
            ...
            <Option type="QString" name="outline_color" value="255,54,0,255,rgb:1,0.21176470588235294,0,1"/>
        ...
        <layer id="{f0ba28d0-601d-4784-8331-1d2b5369826d}" locked="0" enabled="1" class="SimpleLine" pass="0">
          <Option type="Map">
        ...
        <layer id="{b1c74ada-0b54-4d05-b0c1-48852614f85a}" locked="0" enabled="1" class="MarkerLine" pass="0">
          <Option type="Map">
          ...
          <symbol type="marker" frame_rate="10" clip_to_extent="1" alpha="1" is_animated="0" name="@0@2" force_rhr="0">
            ...
            <layer id="{e83a32b6-8ed8-46ba-ab73-58abfd94527a}" locked="0" enabled="1" class="SimpleMarker" pass="0">
              <Option type="Map">
                ...
                <Option type="QString" name="offset_map_unit_scale" value="3x:0,0,0,0,0,0"/>
                <Option type="QString" name="offset_unit" value="MM"/>
                <Option type="QString" name="outline_color" value="35,244,35,255,rgb:0.13725490196078433,0.95686274509803926,0.13725490196078433,1"/>
                <Option type="QString" name="outline_style" value="solid"/>
  ...
  <fieldConfiguration>
    ...
    <field name="conflict" configurationFlags="NoFlag"/>
    <field name="propos" configurationFlags="NoFlag"/>
  </fieldConfiguration>
  <aliases>
    ...
    <alias field="conflict" index="11" name="конфлікт господарської діяльності та збереження довкілля"/>
    <alias field="propos" index="12" name="пропозиції з вирішення конфлікту господарської діяльності та збереження довкілля"/>
  </aliases>
  <splitPolicies>
    ...
    <policy policy="Duplicate" field="conflict"/>
    <policy policy="Duplicate" field="propos"/>
  </splitPolicies>
  <duplicatePolicies>
    <policy policy="Duplicate" field="fid"/>
    <policy policy="Duplicate" field="guid"/>
  ...
  <defaults>
    ...
    <default field="conflict" expression="" applyOnUpdate="0"/>
    <default field="propos" expression="" applyOnUpdate="0"/>
  </defaults>
  <constraints>
    ...
    <constraint field="conflict" unique_strength="0" notnull_strength="1" exp_strength="0" constraints="1"/>
    <constraint field="propos" unique_strength="0" notnull_strength="1" exp_strength="0" constraints="1"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint field="conflict" exp="" desc=""/>
    <constraint field="propos" exp="" desc=""/>
  </constraintExpressions>
  <expressionfields/>
