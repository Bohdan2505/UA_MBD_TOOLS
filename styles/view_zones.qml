...
<qgis styleCategories="Symbology|Labeling|Fields" labelsEnabled="0" version="3.40.0-Bratislava">
  <renderer-v2 type="RuleRenderer" symbollevels="0" referencescale="-1" enableorderby="0" forceraster="0">
    <rules key="{2eabcde5-32c5-427e-b258-bbe8378d6385}">
      <rule symbol="0" key="{92ca4cd2-69cb-47aa-8f9b-64af3de6818a}"/>
    </rules>
    <symbols>
      <symbol type="fill" frame_rate="10" clip_to_extent="1" alpha="1" is_animated="0" name="0" force_rhr="0">
        ...
        <layer id="{6586f036-5355-44fa-afe7-8136c7384dde}" locked="0" enabled="1" class="MarkerLine" pass="0">
          <Option type="Map">
          ...
          <symbol type="marker" frame_rate="10" clip_to_extent="1" alpha="1" is_animated="0" name="@0@0" force_rhr="0">
            ...
            <layer id="{e614afc4-f877-4d2b-8b4e-fafc9b0bbb3c}" locked="0" enabled="1" class="SimpleMarker" pass="0">
              <Option type="Map">
                ...
                <Option type="QString" name="offset_map_unit_scale" value="3x:0,0,0,0,0,0"/>
                <Option type="QString" name="offset_unit" value="MM"/>
                <Option type="QString" name="outline_color" value="17,0,255,255,rgb:0.06666666666666667,0,1,1"/>
        ...
        <layer id="{075d0b7c-cd51-419d-9449-a31792d7cfcc}" locked="0" enabled="1" class="SimpleFill" pass="0">
          <Option type="Map">
            <Option type="QString" name="border_width_map_unit_scale" value="3x:0,0,0,0,0,0"/>
            <Option type="QString" name="color" value="255,255,0,0,rgb:1,1,0,0"/>
            <Option type="QString" name="joinstyle" value="bevel"/>
            <Option type="QString" name="offset" value="0,0"/>
            <Option type="QString" name="offset_map_unit_scale" value="3x:0,0,0,0,0,0"/>
            <Option type="QString" name="offset_unit" value="MM"/>
            <Option type="QString" name="outline_color" value="0,192,255,128,rgb:0,0.75294117647058822,1,0.50196078431372548"/>
            <Option type="QString" name="outline_style" value="solid"/>
