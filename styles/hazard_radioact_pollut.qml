...
<qgis styleCategories="Symbology|Labeling|Fields" labelsEnabled="0" version="3.40.0-Bratislava">
  <renderer-v2 type="RuleRenderer" symbollevels="0" referencescale="-1" enableorderby="0" forceraster="0">
    <rules key="{bf20980a-85d8-4135-9730-2750cad08e71}">
      <rule symbol="0" key="{9b337c56-44bb-4ef3-8b81-fc2e31ea8559}"/>
    </rules>
    <symbols>
      <symbol type="fill" frame_rate="10" clip_to_extent="1" alpha="1" is_animated="0" name="0" force_rhr="0">
        ...
        <layer id="{7410e070-43ef-4d7b-b717-1c7c77200157}" locked="0" enabled="1" class="SimpleLine" pass="0">
          <Option type="Map">
        ...
        <layer id="{082ee78a-e055-4391-8090-7587e9413022}" locked="0" enabled="1" class="MarkerLine" pass="0">
          <Option type="Map">
          ...
          <symbol type="marker" frame_rate="10" clip_to_extent="1" alpha="1" is_animated="0" name="@0@1" force_rhr="0">
            ...
            <layer id="{22c23929-b02f-4018-933d-aadb00c22895}" locked="0" enabled="1" class="EllipseMarker" pass="0">
              <Option type="Map">
        ...
        <layer id="{4319aa71-4867-44f4-b644-81f24451330d}" locked="0" enabled="1" class="MarkerLine" pass="0">
          <Option type="Map">
            <Option type="QString" name="average_angle_length" value="4"/>
            <Option type="QString" name="average_angle_map_unit_scale" value="3x:0,0,0,0,0,0"/>
            <Option type="QString" name="average_angle_unit" value="MM"/>
          ...
          <symbol type="marker" frame_rate="10" clip_to_extent="1" alpha="1" is_animated="0" name="@0@2" force_rhr="0">
            ...
            <layer id="{db74a90f-4ec1-4f00-b695-1fdbd9a7e329}" locked="0" enabled="1" class="EllipseMarker" pass="0">
              <Option type="Map">
                <Option type="QString" name="angle" value="0"/>
                <Option type="QString" name="cap_style" value="square"/>
                <Option type="QString" name="color" value="255,255,255,255,rgb:1,1,1,1"/>
