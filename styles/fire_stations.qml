...
<qgis styleCategories="Symbology|Labeling|Fields" labelsEnabled="0" version="3.40.0-Bratislava">
  <renderer-v2 type="RuleRenderer" symbollevels="0" referencescale="-1" enableorderby="0" forceraster="0">
    ...
    <symbols>
      <symbol type="marker" frame_rate="10" clip_to_extent="1" alpha="1" is_animated="0" name="0" force_rhr="0">
        ...
        <layer id="{a57e47f3-ba52-4d05-8634-04ebc6b9c414}" locked="0" enabled="1" class="SimpleMarker" pass="0">
          <Option type="Map">
        ...
        <layer id="{6aaec917-d4fa-435a-b45d-ef3895ad03bd}" locked="0" enabled="1" class="FontMarker" pass="0">
          <Option type="Map">
            <Option type="QString" name="angle" value="0"/>
            <Option type="QString" name="chr" value="101"/>
      ...
      <symbol type="marker" frame_rate="10" clip_to_extent="1" alpha="1" is_animated="0" name="1" force_rhr="0">
        ...
        <layer id="{96c797fe-fa22-4093-bf67-9b07e34c475f}" locked="0" enabled="1" class="SimpleMarker" pass="0">
          <Option type="Map">
            <Option type="QString" name="angle" value="0"/>
            <Option type="QString" name="cap_style" value="square"/>
            <Option type="QString" name="color" value="255,255,255,255,rgb:1,1,1,1"/>
            ...
            <Option type="QString" name="offset_map_unit_scale" value="3x:0,0,0,0,0,0"/>
            <Option type="QString" name="offset_unit" value="MM"/>
            <Option type="QString" name="outline_color" value="246,0,0,255,rgb:0.96470588235294119,0,0,1"/>
            <Option type="QString" name="outline_style" value="solid"/>
            <Option type="QString" name="outline_width" value="1"/>
            <Option type="QString" name="outline_width_map_unit_scale" value="3x:0,0,0,0,0,0"/>
            <Option type="QString" name="outline_width_unit" value="MM"/>
        ...
        <layer id="{4739dedf-b392-459f-aee9-41992aa67d3c}" locked="0" enabled="1" class="FontMarker" pass="0">
          <Option type="Map">
            <Option type="QString" name="angle" value="0"/>
            <Option type="QString" name="chr" value="101"/>
            <Option type="QString" name="color" value="4,0,0,255,rgb:0.01568627450980392,0,0,1"/>
      ...
      <symbol type="marker" frame_rate="10" clip_to_extent="1" alpha="1" is_animated="0" name="2" force_rhr="0">
        ...
        <layer id="{7f06f130-f506-4e1b-bc50-eb5d0129f13b}" locked="0" enabled="1" class="SimpleMarker" pass="0">
          <Option type="Map">
            <Option type="QString" name="angle" value="0"/>
            <Option type="QString" name="cap_style" value="square"/>
            <Option type="QString" name="color" value="255,255,255,255,rgb:1,1,1,1"/>
        ...
        <layer id="{23c5dcf8-83bf-458e-97e8-b13f86cd0e92}" locked="0" enabled="1" class="FontMarker" pass="0">
          <Option type="Map">
            <Option type="QString" name="angle" value="0"/>
            <Option type="QString" name="chr" value="101"/>
  ...
  <fieldConfiguration>
    ...
    <field name="fire_veh" configurationFlags="NoFlag"/>
    <field name="emer_veh" configurationFlags="NoFlag"/>
  ...
  <aliases>
    ...
    <alias field="type" index="13" name="тип підрозділу"/>
    <alias field="name" index="14" name="назва"/>
    <alias field="fire_veh" index="15" name="кількість пожежно-рятувальних автомобілів, од."/>
    <alias field="emer_veh" index="16" name="кількість аварійно-рятувальних автомобілів, од."/>
    <alias field="san_gap" index="17" name="санітарний (інший) відступ, м"/>
  </aliases>
  <splitPolicies>
    ...
    <policy policy="Duplicate" field="fire_veh"/>
    <policy policy="Duplicate" field="emer_veh"/>
  ...
  <defaults>
    ...
    <default field="fire_veh" expression="" applyOnUpdate="0"/>
    <default field="emer_veh" expression="" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint field="fire_veh" unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0"/>
    <constraint field="emer_veh" unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint field="fire_veh" exp="" desc=""/>
    <constraint field="emer_veh" exp="" desc=""/>
