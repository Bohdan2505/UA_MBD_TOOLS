...
<qgis styleCategories="Symbology|Labeling|Fields" labelsEnabled="0" version="3.40.0-Bratislava">
  <renderer-v2 type="RuleRenderer" symbollevels="0" referencescale="-1" enableorderby="0" forceraster="0">
    <rules key="{10283ee7-c652-4425-907b-7a97817b2694}">
      <rule symbol="0" filter="status=1" label="авіаційні, радіолокаційні обмеження існуючі" key="{57580b24-cae1-4c31-94d5-813f822f8eba}"/>
      <rule symbol="1" filter="status in (2,3,4,5)" label="авіаційні, радіолокаційні обмеження проектні" key="{42e8b90c-5cc9-431e-8201-ea91484cd16a}"/>
      <rule symbol="2" filter="ELSE" label="авіаційні, радіолокаційні обмеження проектні" key="{9b81031b-3326-4286-8822-32b3142949f3}"/>
    </rules>
    <symbols>
      <symbol type="fill" frame_rate="10" clip_to_extent="1" alpha="1" is_animated="0" name="0" force_rhr="0">
        ...
        <layer id="{8b7b215b-c4ca-4708-a938-9ba050cc87d3}" locked="0" enabled="1" class="SimpleLine" pass="0">
          <Option type="Map">
            <Option type="QString" name="align_dash_pattern" value="1"/>
            <Option type="QString" name="capstyle" value="round"/>
            <Option type="QString" name="customdash" value="15;10"/>
            ...
            <Option type="QString" name="line_color" value="3,103,248,255,rgb:0.01176470588235294,0.40392156862745099,0.97254901960784312,1"/>
      ...
      <symbol type="fill" frame_rate="10" clip_to_extent="1" alpha="1" is_animated="0" name="1" force_rhr="0">
        ...
        <layer id="{063c22d9-1616-47be-a104-01fda0b47ecc}" locked="0" enabled="1" class="SimpleLine" pass="0">
          <Option type="Map">
            <Option type="QString" name="align_dash_pattern" value="1"/>
            <Option type="QString" name="capstyle" value="round"/>
            <Option type="QString" name="customdash" value="15;10"/>
      ...
      <symbol type="fill" frame_rate="10" clip_to_extent="1" alpha="1" is_animated="0" name="2" force_rhr="0">
        ...
        <layer id="{124976f1-d53f-4c06-9de7-b54c456533d2}" locked="0" enabled="1" class="SimpleLine" pass="0">
          <Option type="Map">
            <Option type="QString" name="align_dash_pattern" value="1"/>
  ...
  <constraints>
    ...
    <constraint field="status" unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0"/>
