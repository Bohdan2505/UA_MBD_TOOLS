...
<qgis styleCategories="Symbology|Labeling|Fields" labelsEnabled="0" version="3.40.0-Bratislava">
  <renderer-v2 type="RuleRenderer" symbollevels="0" referencescale="-1" enableorderby="0" forceraster="0">
    <rules key="{17c79922-0fef-4b4a-bed0-3ff0dc459aac}">
      <rule symbol="0" key="{e279a41d-8592-442f-9a0d-e657d9b4abd7}"/>
    </rules>
    <symbols>
      <symbol type="line" frame_rate="10" clip_to_extent="1" alpha="1" is_animated="0" name="0" force_rhr="0">
        ...
        <layer id="{52ab2fc7-a147-4be1-94de-2170dfce47e7}" locked="0" enabled="1" class="SimpleLine" pass="0">
          <Option type="Map">
            ...
            <Option type="QString" name="line_color" value="0,82,165,255,rgb:0,0.32156862745098042,0.6470588235294118,1"/>
