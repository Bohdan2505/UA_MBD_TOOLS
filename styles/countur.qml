...
<qgis styleCategories="Symbology|Labeling|Fields" labelsEnabled="0" version="3.40.0-Bratislava">
  <renderer-v2 type="RuleRenderer" symbollevels="0" referencescale="-1" enableorderby="0" forceraster="0">
    <rules key="{d8faab49-057d-4309-9980-bc6b54f05a56}">
      <rule symbol="0" filter="ELSE" label="горизонталі" key="{48cd265c-45f0-4b8c-bf01-c5e711154bcc}"/>
    </rules>
    <symbols>
      <symbol type="line" frame_rate="10" clip_to_extent="1" alpha="1" is_animated="0" name="0" force_rhr="0">
        ...
        <layer id="{73af83df-5087-4d54-aab7-001a9810cb5f}" locked="0" enabled="1" class="SimpleLine" pass="0">
          <Option type="Map">
            ...
            <Option type="QString" name="line_color" value="54,16,0,255,rgb:0.21176470588235294,0.06274509803921569,0,1"/>
  ...
  <aliases>
    ...
    <alias field="value" index="11" name="значення"/>
  </aliases>
  <splitPolicies>
  ...
  <constraints>
    ...
    <constraint field="value" unique_strength="0" notnull_strength="1" exp_strength="0" constraints="1"/>
  </constraints>
