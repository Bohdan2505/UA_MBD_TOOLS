...
<qgis styleCategories="Symbology|Labeling|Fields" labelsEnabled="0" version="3.40.0-Bratislava">
  <renderer-v2 type="RuleRenderer" symbollevels="0" referencescale="-1" enableorderby="0" forceraster="0">
    ...
    <symbols>
      <symbol type="marker" frame_rate="10" clip_to_extent="1" alpha="0.835" is_animated="0" name="0" force_rhr="0">
        ...
        <layer id="{e88cac32-7027-4b00-b9e5-bde671ad4972}" locked="0" enabled="1" class="EllipseMarker" pass="0">
          <Option type="Map">
        ...
        <layer id="{50651ff6-1780-4180-9d82-cec0ef890965}" locked="0" enabled="1" class="SvgMarker" pass="0">
          <Option type="Map">
            <Option type="QString" name="angle" value="0"/>
            <Option type="QString" name="color" value="8,0,0,255,rgb:0.03137254901960784,0,0,1"/>
            <Option type="QString" name="fixedAspectRatio" value="0"/>
            <Option type="QString" name="horizontal_anchor_point" value="1"/>
            <Option type="QString" name="name" value="shopping/shopping_pet2.svg"/>
        ...
        <layer id="{222c19a4-3b47-4b50-8389-f9ba5ac5d114}" locked="0" enabled="1" class="SimpleMarker" pass="0">
          <Option type="Map">
            <Option type="QString" name="angle" value="-90"/>
            <Option type="QString" name="cap_style" value="square"/>
            <Option type="QString" name="color" value="8,0,0,0,rgb:0.03137254901960784,0,0,0"/>
            <Option type="QString" name="horizontal_anchor_point" value="1"/>
      ...
      <symbol type="marker" frame_rate="10" clip_to_extent="1" alpha="0.835" is_animated="0" name="1" force_rhr="0">
        ...
        <layer id="{881004e6-cd15-4e9d-8606-05e982b76ab7}" locked="0" enabled="1" class="EllipseMarker" pass="0">
          <Option type="Map">
            <Option type="QString" name="angle" value="0"/>
            <Option type="QString" name="cap_style" value="square"/>
            <Option type="QString" name="color" value="255,255,255,255,rgb:1,1,1,1"/>
        ...
        <layer id="{fc2986bc-fa62-46c2-ae18-148aeb5e2ae1}" locked="0" enabled="1" class="SvgMarker" pass="0">
          <Option type="Map">
            <Option type="QString" name="angle" value="0"/>
            <Option type="QString" name="color" value="249,0,0,255,rgb:0.97647058823529409,0,0,1"/>
            <Option type="QString" name="fixedAspectRatio" value="0"/>
            <Option type="QString" name="horizontal_anchor_point" value="1"/>
            <Option type="QString" name="name" value="shopping/shopping_pet2.svg"/>
            <Option type="QString" name="offset" value="0,1"/>
        ...
        <layer id="{4deec0b0-d450-4e3e-b771-6bda0143e6f4}" locked="0" enabled="1" class="SimpleMarker" pass="0">
          <Option type="Map">
            <Option type="QString" name="angle" value="-90"/>
            <Option type="QString" name="cap_style" value="square"/>
            <Option type="QString" name="color" value="8,0,0,0,rgb:0.03137254901960784,0,0,0"/>
      ...
      <symbol type="marker" frame_rate="10" clip_to_extent="1" alpha="0.835" is_animated="0" name="2" force_rhr="0">
        ...
        <layer id="{7fa7c134-0a5c-49bd-b90c-7d78e050b14c}" locked="0" enabled="1" class="EllipseMarker" pass="0">
          <Option type="Map">
            <Option type="QString" name="angle" value="0"/>
            <Option type="QString" name="cap_style" value="square"/>
            <Option type="QString" name="color" value="255,255,255,255,rgb:1,1,1,1"/>
            ...
            <Option type="QString" name="offset_map_unit_scale" value="3x:0,0,0,0,0,0"/>
            <Option type="QString" name="offset_unit" value="MM"/>
            <Option type="QString" name="outline_color" value="131,131,131,255,rgb:0.51372549019607838,0.51372549019607838,0.51372549019607838,1"/>
            <Option type="QString" name="outline_style" value="solid"/>
            <Option type="QString" name="outline_width" value="0.7"/>
            <Option type="QString" name="outline_width_map_unit_scale" value="3x:0,0,0,0,0,0"/>
            <Option type="QString" name="outline_width_unit" value="MM"/>
        ...
        <layer id="{7a357766-1866-4ba7-b4c0-16aa2451cc54}" locked="0" enabled="1" class="SvgMarker" pass="0">
          <Option type="Map">
            <Option type="QString" name="angle" value="0"/>
            <Option type="QString" name="color" value="131,131,131,255,rgb:0.51372549019607838,0.51372549019607838,0.51372549019607838,1"/>
            <Option type="QString" name="fixedAspectRatio" value="0"/>
            <Option type="QString" name="horizontal_anchor_point" value="1"/>
            <Option type="QString" name="name" value="shopping/shopping_pet2.svg"/>
            <Option type="QString" name="offset" value="0,1"/>
        ...
        <layer id="{9259e06a-6275-4691-8342-5379606629b8}" locked="0" enabled="1" class="SimpleMarker" pass="0">
          <Option type="Map">
            <Option type="QString" name="angle" value="-90"/>
            <Option type="QString" name="cap_style" value="square"/>
            <Option type="QString" name="color" value="8,0,0,0,rgb:0.03137254901960784,0,0,0"/>
  ...
  <fieldConfiguration>
    ...
    <field name="sang_in" configurationFlags="NoFlag"/>
    <field name="sang_pr" configurationFlags="NoFlag"/>
    <field name="sang_pro" configurationFlags="NoFlag"/>
    <field name="sang_ext" configurationFlags="NoFlag"/>
  </fieldConfiguration>
  <aliases>
    ...
    <alias field="cap_in" index="14" name="місткість існуюча, тварин"/>
    <alias field="cap_pr" index="15" name="місткість на короткостроковий період, тварин"/>
    <alias field="cap_pro" index="16" name="місткість на середньостроковий період, тварин"/>
    <alias field="cap_ext" index="17" name="місткість на довгостроковий період, тварин"/>
    <alias field="sang_in" index="18" name="санітарний (інший) відступ існуючий, м"/>
    <alias field="sang_pr" index="19" name="санітарний (інший) відступ на короткостроковий період, м"/>
    <alias field="sang_pro" index="20" name="санітарний (інший) відступ на середньостроковий період, м"/>
    <alias field="sang_ext" index="21" name="санітарний (інший) відступ на довгостроковий період, м"/>
  </aliases>
  <splitPolicies>
    ...
    <policy policy="Duplicate" field="sang_in"/>
    <policy policy="Duplicate" field="sang_pr"/>
    <policy policy="Duplicate" field="sang_pro"/>
    <policy policy="Duplicate" field="sang_ext"/>
  </splitPolicies>
  <duplicatePolicies>
    <policy policy="Duplicate" field="fid"/>
    <policy policy="Duplicate" field="guid"/>
  ...
  <defaults>
    ...
    <default field="sang_in" expression="" applyOnUpdate="0"/>
    <default field="sang_pr" expression="" applyOnUpdate="0"/>
    <default field="sang_pro" expression="" applyOnUpdate="0"/>
    <default field="sang_ext" expression="" applyOnUpdate="0"/>
  </defaults>
  <constraints>
    ...
    <constraint field="sang_in" unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0"/>
    <constraint field="sang_pr" unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0"/>
    <constraint field="sang_pro" unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0"/>
    <constraint field="sang_ext" unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint field="sang_in" exp="" desc=""/>
    <constraint field="sang_pr" exp="" desc=""/>
    <constraint field="sang_pro" exp="" desc=""/>
    <constraint field="sang_ext" exp="" desc=""/>
  </constraintExpressions>
  <expressionfields/>
