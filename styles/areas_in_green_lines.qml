...
<qgis styleCategories="Symbology|Labeling|Fields" labelsEnabled="0" version="3.40.0-Bratislava">
  <renderer-v2 type="RuleRenderer" symbollevels="0" referencescale="-1" enableorderby="0" forceraster="0">
    <rules key="{c6a03202-c598-4080-aa52-cc1eeddb9aa3}">
      <rule symbol="0" filter="res_code='06.01.2'" label="території в зелених лініях" key="{e1d6aa7e-c27d-4f94-a96e-b7d87eb2b7e0}"/>
    </rules>
    <symbols>
      <symbol type="fill" frame_rate="10" clip_to_extent="1" alpha="1" is_animated="0" name="0" force_rhr="0">
        ...
        <layer id="{5c0ea775-00f5-4f6e-9334-f4002fc267c8}" locked="0" enabled="1" class="SimpleLine" pass="0">
          <Option type="Map">
            ...
            <Option type="QString" name="line_color" value="77,175,74,255,rgb:0.30196078431372547,0.68627450980392157,0.29019607843137257,1"/>
  ...
  <constraints>
    ...
    <constraint field="res_code" unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0"/>
  </constraints>
