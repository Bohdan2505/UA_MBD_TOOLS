...
<qgis styleCategories="Symbology|Labeling|Fields" labelsEnabled="0" version="3.40.0-Bratislava">
  <renderer-v2 type="RuleRenderer" symbollevels="0" referencescale="-1" enableorderby="0" forceraster="0">
    <rules key="{ca6eade9-6d73-41dc-af68-a8b045dc22cf}">
      <rule symbol="0" filter="status=1" label="існуючі" key="{349834e7-b1e0-447e-97c4-c54d9ac12d19}"/>
      <rule symbol="1" filter="status in (2,3,4,5)" label="проектні" key="{da93ecc4-9889-44ca-b283-3c9eaafd052c}"/>
      <rule symbol="2" filter="ELSE" label="інші" key="{58bebeb7-ddeb-4911-95a1-8761199ad0f5}"/>
    </rules>
    <symbols>
      <symbol type="line" frame_rate="10" clip_to_extent="1" alpha="1" is_animated="0" name="0" force_rhr="0">
        ...
        <layer id="{7cda65a5-24a5-4c21-a012-7bb3a035aab1}" locked="0" enabled="1" class="SimpleLine" pass="0">
          <Option type="Map">
      ...
      <symbol type="line" frame_rate="10" clip_to_extent="1" alpha="1" is_animated="0" name="1" force_rhr="0">
        ...
        <layer id="{baa4e537-fb12-48a1-8c65-e4855238ba88}" locked="0" enabled="1" class="SimpleLine" pass="0">
          <Option type="Map">
            <Option type="QString" name="align_dash_pattern" value="0"/>
            <Option type="QString" name="capstyle" value="square"/>
            <Option type="QString" name="customdash" value="5;2"/>
            ...
            <Option type="QString" name="draw_inside_polygon" value="0"/>
            <Option type="QString" name="joinstyle" value="bevel"/>
            <Option type="QString" name="line_color" value="255,128,0,255,rgb:1,0.50196078431372548,0,1"/>
            <Option type="QString" name="line_style" value="dash"/>
            <Option type="QString" name="line_width" value="2"/>
            <Option type="QString" name="line_width_unit" value="MM"/>
            <Option type="QString" name="offset" value="0"/>
      ...
      <symbol type="line" frame_rate="10" clip_to_extent="1" alpha="1" is_animated="0" name="2" force_rhr="0">
        ...
        <layer id="{05aaf798-32ba-4f3a-b168-4001ac33eabf}" locked="0" enabled="1" class="SimpleLine" pass="0">
          <Option type="Map">
            <Option type="QString" name="align_dash_pattern" value="0"/>
            <Option type="QString" name="capstyle" value="square"/>
            <Option type="QString" name="customdash" value="5;2"/>
  ...
  <aliases>
    ...
    <alias field="change" index="11" name="проектна зміна статусу"/>
