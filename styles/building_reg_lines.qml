...
<qgis styleCategories="Symbology|Labeling|Fields" labelsEnabled="0" version="3.40.0-Bratislava">
  <renderer-v2 type="RuleRenderer" symbollevels="0" referencescale="-1" enableorderby="0" forceraster="0">
    <rules key="{a1ec357d-ab8a-4060-a96b-a72afa63a7a8}">
      <rule symbol="0" filter="res_code='06.01.5'" label="території в лініях регулювання забудови" key="{881facdf-2414-405d-9eab-f4108575a4f5}"/>
    </rules>
    <symbols>
      <symbol type="fill" frame_rate="10" clip_to_extent="1" alpha="1" is_animated="0" name="0" force_rhr="0">
        ...
        <layer id="{1d0a970d-f582-46c3-bb5c-408ebce67209}" locked="0" enabled="1" class="SimpleLine" pass="0">
          <Option type="Map">
        ...
        <layer id="{5bc69ea8-8900-4ca1-8831-bcb0327d5a07}" locked="0" enabled="1" class="MarkerLine" pass="0">
          <Option type="Map">
          ...
          <symbol type="marker" frame_rate="10" clip_to_extent="1" alpha="1" is_animated="0" name="@0@1" force_rhr="0">
            ...
            <layer id="{8d3f2b6e-73fb-4208-808b-3bbb55a431bb}" locked="0" enabled="1" class="FontMarker" pass="0">
              <Option type="Map">
                <Option type="QString" name="angle" value="0"/>
                <Option type="QString" name="chr" value="РЗ"/>
                <Option type="QString" name="color" value="246,35,35,255,rgb:0.96470588235294119,0.13725490196078433,0.13725490196078433,1"/>
        ...
        <layer id="{b7f374ae-0e2c-4d84-8313-86325c964dfc}" locked="0" enabled="1" class="MarkerLine" pass="0">
          <Option type="Map">
            <Option type="QString" name="average_angle_length" value="4"/>
            <Option type="QString" name="average_angle_map_unit_scale" value="3x:0,0,0,0,0,0"/>
            <Option type="QString" name="average_angle_unit" value="MM"/>
          ...
          <symbol type="marker" frame_rate="10" clip_to_extent="1" alpha="1" is_animated="0" name="@0@2" force_rhr="0">
            ...
            <layer id="{a9be130a-be92-4b71-aacf-d1578a857166}" locked="0" enabled="1" class="SimpleMarker" pass="0">
              <Option type="Map">
                <Option type="QString" name="angle" value="0"/>
