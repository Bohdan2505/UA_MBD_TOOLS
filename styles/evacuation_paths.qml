...
<qgis styleCategories="Symbology|Labeling|Fields" labelsEnabled="0" version="3.40.0-Bratislava">
  <renderer-v2 type="RuleRenderer" symbollevels="0" referencescale="-1" enableorderby="0" forceraster="0">
    <rules key="{a6a62a7e-8b35-49b2-a538-16ea32570389}">
      <rule symbol="0" key="{88bdac8e-1e3b-49a1-8461-f322e534f1f4}"/>
    </rules>
    <symbols>
      <symbol type="line" frame_rate="10" clip_to_extent="1" alpha="1" is_animated="0" name="0" force_rhr="0">
        ...
        <layer id="{08720196-b126-40fd-9f75-9b4252f935a2}" locked="0" enabled="1" class="SimpleLine" pass="0">
          <Option type="Map">
            ...
            <Option type="QString" name="line_color" value="76,0,0,255,rgb:0.29803921568627451,0,0,1"/>
        ...
        <layer id="{de897076-ae85-4c1f-878b-b741607c1010}" locked="0" enabled="1" class="MarkerLine" pass="0">
          <Option type="Map">
            <Option type="QString" name="average_angle_length" value="5"/>
          ...
          <symbol type="marker" frame_rate="10" clip_to_extent="1" alpha="1" is_animated="0" name="@0@1" force_rhr="0">
            ...
            <layer id="{e8ada322-c1ea-4975-af1e-acf1d71f8118}" locked="0" enabled="1" class="EllipseMarker" pass="0">
              <Option type="Map">
                <Option type="QString" name="angle" value="90"/>
                <Option type="QString" name="cap_style" value="square"/>
                <Option type="QString" name="color" value="76,0,0,255,rgb:0.29803921568627451,0,0,1"/>
  ...
  <fieldConfiguration>
    ...
    <field name="st_guid" configurationFlags="NoFlag"/>
  </fieldConfiguration>
  <aliases>
    ...
    <alias field="st_guid" index="11" name=""/>
  </aliases>
  <splitPolicies>
    ...
    <policy policy="Duplicate" field="st_guid"/>
  </splitPolicies>
  <duplicatePolicies>
    <policy policy="Duplicate" field="fid"/>
    <policy policy="Duplicate" field="guid"/>
  ...
  <defaults>
    ...
    <default field="st_guid" expression="" applyOnUpdate="0"/>
  </defaults>
  <constraints>
    ...
    <constraint field="st_guid" unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint field="st_guid" exp="" desc=""/>
  </constraintExpressions>
  <expressionfields/>
